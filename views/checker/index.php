...
?>
<h2><?= \Yii::t('skeeks/cms','Full system testing')?></h2>
<p>
    <?=\Yii::t('skeeks/cms','Full system scan helps to find the causes of the problems in the work site, and avoid errors in the future. Help for each test will help eliminate the cause of the error.')?>
</p>
<div class="sx-box sx-p-10 sx-bg-primary sx-checker">
    <p>
        <a href="#" class="btn btn-primary sx-controll-start"><i class="glyphicon glyphicon-play"></i> <?= \Yii::t('skeeks/cms','Start testing') ?></a>
        <a href="#" class="btn btn-default sx-controll-stop"><i class="glyphicon glyphicon-stop"></i> <?= \Yii::t('skeeks/cms','Stop') ?></a>
    </p>

    <p>
        <div class="sx-progress-tasks" id="sx-progress-tasks" style="display: none;">
            <span style="vertical-align:middle;"><h3><?= \Yii::t('skeeks/cms','"Testing the system (Progress"') ?> <span class="sx-executing-ptc"></span>%)</h3></span>
            <span style="vertical-align:middle;"><?= \Yii::t('skeeks/cms','Test') ?>: <span class="sx-executing-task-name"></span></span>
            <div>
