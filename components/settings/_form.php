...
<?= $form->fieldSet(\Yii::t('skeeks/cms','Language settings')); ?>
...
<?= $form->fieldSet(\Yii::t('skeeks/cms','Setting tables')); ?>
...
<?= $form->fieldSet(\Yii::t('skeeks/cms','Setting the visual editor')); ?>
    ...
    <?= $form->fieldRadioListBoolean($model, 'ckeditorCodeSnippetGeshi')->hint(\Yii::t('skeeks/cms','It will be activated this plugin') . ' http://ckeditor.com/addon/codesnippetgeshi'); ?>
    ...
    ])->hint('https://highlightjs.org/static/demo/ - ' . \Yii::t('skeeks/cms','topics')); ?>
<?= $form->fieldSetEnd(); ?>

<?= $form->fieldSet(\Yii::t('skeeks/cms','Security')); ?>
    <?= $form->fieldInputInt($model, 'blockedTime')->hint(\Yii::t('skeeks/cms','If a user, for a specified time, not active in the admin panel, it will be prompted for a password.')); ?>
<?= $form->fieldSetEnd(); ?>
...
<?= $form->fieldSet(\Yii::t('skeeks/cms','Access')); ?>
    ...
    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        ...
        'label'                 => \Yii::t('skeeks/cms','Access to the administrate area'),
    ]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => \skeeks\cms\rbac\CmsManager::PERMISSION_EDIT_VIEW_FILES,
        'label'                 => \Yii::t('skeeks/cms','The ability to edit view files'),
    ]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => "cms/admin-settings",
        'label'                 => \Yii::t('skeeks/cms','The ability to edit settings'),
    ]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => \skeeks\cms\rbac\CmsManager::PERMISSION_ADMIN_DASHBOARDS_EDIT,
        'label'                 => \Yii::t('skeeks/cms','Access to edit dashboards'),
    ]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => \skeeks\cms\rbac\CmsManager::PERMISSION_USER_FULL_EDIT,
        'label'                 => \Yii::t('skeeks/cms','The ability to manage user groups'),
    ]); ?>


    <?= \skeeks\cms\modules\admin\widgets\BlockTitleWidget::widget(['content' => \Yii::t('skeeks/cms',"Control recodrs")]); ?>
    ...
    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        ...
        'label'                 => \Yii::t('skeeks/cms','The ability to update records'),
    ]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => \skeeks\cms\rbac\CmsManager::PERMISSION_ALLOW_MODEL_UPDATE_ADVANCED,
        'label'                 => \Yii::t('skeeks/cms','The ability to update service information at records'),
    ]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => \skeeks\cms\rbac\CmsManager::PERMISSION_ALLOW_MODEL_DELETE,
        'label'                 => \Yii::t('skeeks/cms','Ability to delete records'),
    ]); ?>

    <?= \skeeks\cms\modules\admin\widgets\BlockTitleWidget::widget(['content' => \Yii::t('skeeks/cms','Control only own records')]); ?>

    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        'permissionName'        => \skeeks\cms\rbac\CmsManager::PERMISSION_ALLOW_MODEL_UPDATE_OWN,
        'label'                 => \Yii::t('skeeks/cms','The ability to update their records'),
    ]); ?>
    ...
    <?= \skeeks\cms\widgets\rbac\PermissionForRoles::widget([
        ...
        'label'                 => \Yii::t('skeeks/cms','Ability to delete own records'),
    ]); ?>
